              ...
              <form action="list.html" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
				  ...
				  <tr>
                  <td class="td_right">密码：</td><td><input type="password" name="name" class="input-text lh30" size="40"></td>
                </tr>
					   <tr>
               ...
               <tr>
                  <td class="td_right">状态：</td>
                  <td class="">
                    <input type="radio" name="sex" checked> 启用
                    <input type="radio" name="sex"> 冻结
                  </td>
				  </tr>
                 <tr>
