              ...
              <form action="list.html" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="name" class="input-text lh30" size="40" value="zhangsan">
                  </td>
				  </tr>
				  <tr>
                  <td class="td_right">密码：</td>
				  <td><input name="name" class="input-text lh30" size="40" value="123456" ></td>
                </tr>
					   <tr>
						  <td class="td_right">真实姓名：</td>
						  <td class=""> 
							<input type="text" name="name" class="input-text lh30" size="40" value="张三">
						  </td>
					  </tr>
					   <tr>
						  <td class="td_right">身份证：</td>
						  <td class=""> 
							<input type="text" name="name" class="input-text lh30" size="40" value="142703159841101">
						  </td>
					  </tr>
					   <tr>
						  <td class="td_right">年龄：</td>
						  <td class=""> 
							<input type="text" name="name" class="input-text lh30" size="10" value="20">
						  </td>
					  </tr>
                                           <tr>
						  <td class="td_right">手机号：</td>
						  <td class=""> 
							<input type="text" name="name" class="input-text lh30" size="10">
						  </td>
					  </tr>
				<tr>
                ...
                <tr >
                  ...
                  <td class="">
                    ...
                    <span class="fl">
                      <div class="select_border"> 
						...
						<option>选择机构</option>
                        <option selected>华电</option> 
                        <option>职业教育学院</option> 
                        </select> 
                        </div> 
                      </div> 
                    </span>&nbsp;&nbsp;&nbsp;
                 ...
                 <tr>
                  ...
                  <td class="">
                    ...
                    <input type="radio" name="status"> 冻结
                  </td>
                 </tr>
