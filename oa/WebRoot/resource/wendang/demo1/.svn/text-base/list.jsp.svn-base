            ...
            <div class="box_center pt10 pb10">
             ...
             <div  class="box_bottom pb5 pt5 pr10" style="border-top:1px solid #dadada;">
              <div class="search_bar_btn" style="text-align:center;" >
                 <a href="add.html" class="ext_btn"><span class="add"></span>添加文件夹</a>
                 <a href="add1.html" class="ext_btn"><span class="add"></span>添加文件</a>
              </div>
            </div>
			</div>  </div>
			</form>
        ...
        <div class="box span10 oh">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <tr class="tr" align="center">
                   ...
                   <td><a href="list1.html">部门共享文件夹</a></td>
                   <td>文件夹</td>
				   <td>研发部</td>
                   <td>2015-12-12</td>
				   <td>
				 ...
				 <tr class="tr" align="center">
                   <td class="td_center"><input type="checkbox"></td>
                   <td><a href="list1.html">李四文件夹</a></td>
                   <td>文件夹</td>
				   <td>李四</td>
                   <td>2015-12-12</td>
				   <td>
               ...
               <tr class="tr" align="center">
                   <td class="td_center"><input type="checkbox"></td>
                   <td><a href="list1.html">张三文件夹</a></td>
                   <td>文件夹</td>
				   <td>张三</td>
                   <td>2015-12-12</td>
				   <td>
