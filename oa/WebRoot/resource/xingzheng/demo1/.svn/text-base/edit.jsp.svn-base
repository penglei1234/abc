  ...
  <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">编辑会议室</b></div>
              ...
              <form action="list.html" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="name" class="input-text lh30" size="40" value="C212">
                  </td>
				  </tr>
				  <tr>
                  <td class="td_right">会议室描述：</td>
				  <td><input type="" name="name" class="input-text lh30" size="40" value="C座2楼多媒体会议室"></td>
                </tr>
                 <tr>
