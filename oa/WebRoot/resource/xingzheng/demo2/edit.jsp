              ...
              <form action="list.html" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="name" class="input-text lh30" size="40" value="京A1221">
                  </td>
				  </tr>
				  <tr>
                  <td class="td_right">车型：</td>
				  <td><input type="" name="name" class="input-text lh30" size="40" value="金杯小货车"></td>
                </tr>
				<tr>
                  <td class="td_right">颜色：</td>
				  <td><input type="" name="name" class="input-text lh30" size="40" value="黑色"></td>
                </tr>
				<tr>
                  <td class="td_right">备注：</td>
				  <td><textarea class="input-text lh30" >无</textarea></td>
                </tr>
                 <tr>
