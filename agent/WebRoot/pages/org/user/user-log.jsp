...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;当前位置：
    <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;用户管理&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;LOG日志</td>
  </tr>
  <tr>
    <td style="height:34px; background-image:url(images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>LOG日志</strong></td>
          <td align="right" class="white" style="padding-right:20px">
		   <a href="#" class="barBtn" onClick="javascript:history.go(-1);"><img src="images/btn_left.gif" align="absmiddle"> 后退</a> <a href="#" class="barBtn" onClick="javascript:history.go(+1);"><img src="images/btn_right.gif" align="absmiddle"> 前进</a>
		  </td>
        </tr>
    </table></td>
  </tr>
  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        <TR>
          <th align="center">登录账户</th>
          <th align="center">操作信息</th>
          <th align="center">操作时间</th>
        </TR>
        <TR>
          <TD align="center">DLS_1</TD>
          <TD align="center">用户注销账号操作成功</TD>
          <TD align="center">2013-5-03 17:16:36</TD>
        </TR>
		<TR>
          <TD align="center">DLS_1</TD>
          <TD align="center">用户注销账号操作成功</TD>
