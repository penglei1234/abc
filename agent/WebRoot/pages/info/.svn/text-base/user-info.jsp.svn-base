...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td style="height:25px; background-color:#f3f3f3; font-weight:bold" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;当前位置： <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;用户管理&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;用户详情</td>
  </tr>
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        <TR>
          ...
          <TD class="BGCgray"><input type="text" value="${sessionScope.user.userLogName }"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">登录密码</th>
          <TD class="BGCgray"><input type="password" value="${sessionScope.user.userPassword }"/></TD>
        </TR>
        <TR>
          <th align="center">用户姓名</th>
          <TD width="80%" class="BGCgray"><input type="text" value="${sessionScope.user.userLogName }" /></TD>
        </TR>
        <TR>
