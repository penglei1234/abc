...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td style="height:25px; background-color:#f3f3f3; font-weight:bold" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;当前位置： <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;个人中心&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;个人详情</td>
  </tr>
  <tr>
    <td style="height:34px; background-image:url(images/main_headerL.gif); border-bottom:1px solid #cfd8e0; padding:0px">
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        <TR>
          ...
          <TD class="BGCgray"><img src="" width="80px" height="100px"/></TD>
        </TR>
        <TR>
          <th width="20%" align="center">登录账号</th>
          <TD class="BGCgray"><input type="text" value="admin"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">登录密码</th>
          <TD class="BGCgray"><input type="password" value="admin"/></TD>
        </TR>
        <TR>
          <th width="20%" align="center">真实姓名</th>
          <TD class="BGCgray"><input type="password"/></TD>
        </TR>
        <TR>
          <th align="center">身份证</th>
          <TD width="80%" class="BGCgray"><input type="text" /></TD>
        </TR>
        <TR>
        ...
        <TR>
        	<th align="center">启用状态</th>
          	<TD class="BGCgray">
            	<input type="radio" name="status"  checked />启用<input type="radio" name="status" />禁用
            </TD>
        </TR>
        <TR>
