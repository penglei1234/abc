    ...
    <input type="hidden" name="userId" value="${sessionScope.user.userId }" />
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        <TR>
          ...
          <TD class="BGCgray"><img src='<c:if test="${sessionScope.fileName==null }">images/gril.jpg</c:if><c:if test="${sessionScope.fileName!=null }">upload/${sessionScope.fileName }</c:if>' width="80px" height="100px"/></TD>
