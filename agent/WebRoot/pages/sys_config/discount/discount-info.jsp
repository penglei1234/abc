    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD class="BGCgray"><input type="text" readonly="readonly" value="${discountTb.dsctType}"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">类型数值</th>
          <TD class="BGCgray"><input type="text" readonly="readonly" value="${discountTb.dsctYear}"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">实际数值</th>
          <TD class="BGCgray"><input type="text" readonly="readonly" value="${discountTb.realYear}"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">是否启用</th>
          <TD class="BGCgray">
			<input type="radio" name="state" id="on" readonly="readonly" value="1" ${discountTb.state==1?"checked":"" } checked /><label for="on">启用</label>
			<input type="radio" name="state" id="off" readonly="readonly" value="0" ${discountTb.state==0?"checked":"" }/><label for="off">禁用</label>
		  </TD>
        </TR>
