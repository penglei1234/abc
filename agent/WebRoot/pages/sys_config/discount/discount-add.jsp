...
function discountInsert(){
    	...
    	span.innerHTML="<font color='red'>类型不能为空，请重新输入</font>";	
    		...
    		location.href="discount?method=insert&id="+${discountTb.id }+"&dsctType1="+dsctType+"&dsctYear1"+dsctYear+"&realYear1"+realYear+"&state="+state;	
    	}
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD class="BGCgray"><input type="text" name="dsctType" id="dsctType"/><span id="dsctTypeSpan"></span></TD>
        </TR>
		<TR>
          <th width="20%" align="center">类型数值</th>
          <TD class="BGCgray"><input type="text" name="dsctYear" id="dsctYear"/><span id="dsctYearSpan"></span></TD>
        </TR>
		<TR>
          <th width="20%" align="center">实际数值</th>
          <TD class="BGCgray"><input type="text" name="realYear" id="realYear"/><span id="realYearSpan"></span></TD>
        </TR>
		<TR>
      ...
      <div style="width:100%; text-align:center; padding:5px">
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('保存信息？')) discountInsert();else return;"><img src="images/btn_save.gif" width="16" height="16" align="absmiddle"> 保存</BUTTON>
