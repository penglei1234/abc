...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;当前位置：
    <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;系统配置管理&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;客户类型</td>
  </tr>
  <tr>
    <td style="height:34px; background-image:url(images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>客户类型</strong></td>
          <td align="right" class="white" style="padding-right:20px">
		  <a href="pages/sys_config/customerType/customerType-add.jsp" class="barBtn""><img src="images/5.png" align="absmiddle"> 新增</a> 
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
      <TR>
        ...
        <td width="20%" class="BGCgray"><input type="text" name="cstmType" value="${requestScope.cstmType }"></td>
        <th width="10%" align="center"><BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('查询数据？')) location.href='#';else return;">
  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <c:forEach items="${requestScope.customerTypeTbList}" var="cuslist" begin="0" end="5" step="1" varStatus="start">
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
		  <TD align="center">${start.index+1}</TD>
		  <TD align="center">${cuslist.cstmType }</TD>
		  <TD align="center"><c:if test="${cuslist.state=='1' }">启用</c:if>
                             <c:if test="${cuslist.state=='0' }">禁用</c:if></TD>
  
          <TD width="160" align="center">
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='customer?method=select&id=${cuslist.tid}';else return;">查看</BUTTON>
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该菜单？')) location.href='customer?method=update&id=${cuslist.tid}';else return;">编辑</BUTTON> 
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('删除该菜单？')) location.href='customer?method=delete&id=${cuslist.tid}';else return;">删除</BUTTON>
		  </TD>
        </TR>
        </c:forEach>
		<!-- <TR>
          ...
          <TD width="160" align="center">
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='customerType-info.jsp';else return;">查看</BUTTON>
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该菜单？')) location.href='customerType-edit.jsp';else return;">编辑</BUTTON> 
  ...
  <!--  分页和模糊查询的实现 -->   
<p:page url="customer?method=selectAll&cstmType=${requestScope.cstmType }&pageNow="
