    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD class="BGCgray"><input type="text" readonly="readonly" value="${customerTb.cstmType}"/></TD>
        </TR>
		<TR>
          <th width="20%" align="center">是否启用</th>
          <TD class="BGCgray">
			<input type="radio" name="state" id="on" value="1" readonly="readonly" ${customerTb.state==1?"checked":"" } checked /><label for="on">启用</label>
			<input type="radio" name="state" id="off" value="0" readonly="readonly" ${customerTb.state==0?"checked":"" }/><label for="off">禁用</label>
		  </TD>
        </TR>
