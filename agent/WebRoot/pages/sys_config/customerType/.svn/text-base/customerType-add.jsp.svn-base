...
function costomerInsert(){
    	...
    	span.innerHTML="<font color='red'>客户类型不能为空，请重新输入</font>";	
    	}else{
    		location.href="customer?method=insert&cstmType1="+cstmType+"&state="+state;	
    	}
    }
</script>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD class="BGCgray"><input type="text" name="cstmType" id="cstmType"/><span id="cstmTypeSpan"></span></TD>
        </TR>
		<TR>
      ...
      <div style="width:100%; text-align:center; padding:5px">
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('保存信息？'))costomerInsert();else return;"><img src="images/btn_save.gif" width="16" height="16" align="absmiddle"> 保存</BUTTON>
