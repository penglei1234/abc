...
function serviceInsert(){
    	...
    	if(svcType!=""&&money!=""){
    		location.href="service?method=insert&svcType1="+svcType+"&money="+money+"&state="+state;	
    	}else{
    	if(svcType=""){
    ...
    <td style="height:34px; background-image:url(images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>服务类型</strong></td>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        <TR>
          ...
          <TD class="BGCgray"><input type="text" name="svcType" id="svcType"/>
          <span id="svcTypeSpan"></span></TD>
          </TR>
        <TR>
          <th align="center">类型数值</th>
      ...
      <div style="width:100%; text-align:center; padding:5px">
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('保存信息？')) serviceInsert();else return;"><img src="images/btn_save.gif" width="16" height="16" align="absmiddle"> 保存</BUTTON>
