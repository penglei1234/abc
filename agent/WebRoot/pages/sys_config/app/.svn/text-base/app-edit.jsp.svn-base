...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td style="height:25px; background-color:#f3f3f3; font-weight:bold" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;当前位置： <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;系统配置管理&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;app地址</td>
  </tr>
  <tr>
    <td style="height:34px; background-image:url(images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>app地址</strong></td>
  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          <th width="20%" align="center" colspan="2"><h1>APP URL管理-填写制作APP的系统的URL地址</h1></th>
        </TR>
		<TR>
          <th width="20%" align="center">配置名称</th>
          <TD class="BGCgray"><input type="text" name=""/><span></span></TD>
        </TR>
		<TR>
          <th width="20%" align="center">配置数值</th>
          <TD class="BGCgray"><input type="text"/><span></span></TD>
        </TR>
		</table>
