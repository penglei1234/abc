...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;当前位置：
    <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;代理商管理系统&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;系统配置管理&nbsp;&nbsp; <img src="images/arrow.gif" align="absmiddle">&nbsp;&nbsp;财务类型</td>
  </tr>
  <tr>
    <td style="height:34px; background-image:url(images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>财务类型</strong></td>
          <td align="right" class="white" style="padding-right:20px">
		  <a href="pages/sys_config/finaceType/finType-add.jsp" class="barBtn""><img src="images/5.png" align="absmiddle"> 新增</a> 
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
      <TR>
        <form action="finaceTb" method="post">
        <input type="hidden" name="type" value="selectAll"/>
        <th width="10%" align="center">配置类型</th>
        <td width="20%" class="BGCgray"><input type="text" name="finaceType" id="finaceType" value="${requestScope.finaceType }"></td>
  ...
  <tr>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <c:forEach items="${requestScope.finaceTypelist}" var="flist" begin="0" end="5" step="1" varStatus="start">
        <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
		  <TD align="center">${start.index+1}</TD>
          <TD align="center">${flist.finaceType }</TD>
          <TD align="center"><c:if test="${flist.state=='1' }">启用</c:if>
                             <c:if test="${flist.state=='0' }">禁用</c:if></TD>
          <TD width="160" align="center">
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='finaceTb?type=selectById&id=${flist.id}';else return;">查看
		  </BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该菜单？')) location.href='finaceTb?type=update&id=${flist.id}';else return;">编辑</BUTTON> 
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('删除该菜单？')) location.href='finaceTb?type=delete&id=${flist.id}';else return;">删除</BUTTON></TD>
        </TR>
        </c:forEach>
		<!--  <TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          ...
          <TD width="160" align="center">
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='finType-info.jsp';else return;">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该菜单？')) location.href='finType-edit.jsp';else return;">编辑</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('删除该菜单？')) alert('操作成功！');else return;">删除</BUTTON></TD>
        </TR>
		<TR>
          <TD align="center"><input type="checkbox" name="checkbox2" id="checkbox2"></TD>
          <TD align="center">3</TD>
		  <TD align="center">财务打款</TD>
          <TD align="center">启用</TD>
          <TD width="160" align="center">
		  <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='finType-info.jsp';else return;">查看</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该菜单？')) location.href='finType-edit.jsp';else return;">编辑</BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('删除该菜单？')) alert('操作成功！');else return;">删除</BUTTON></TD>
        </TR>
      ...
      <p:page url="finaceTb?type=selectAll&finaceType=${requestScope.finaceType }&pageNow="
