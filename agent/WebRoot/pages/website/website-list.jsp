	...
	<form id="form2" method="post">   	
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
		  ...
		  <td align="center"><a href="webSite?type=view&flag=fromlist&id=${company.cid}">${company.cname }</a></td>
		  ...
		  <td align="center">
		  <input type="button" value="查看" style="height:21px; font-size:12px;" onClick="javascript:if (confirm('查看该菜单详情？')) location.href='webSite?type=view&flag=fromlist&id=${company.cid}'" />
