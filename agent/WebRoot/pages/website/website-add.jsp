    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table  id="addTable" width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
		...
		<TR>
		  ...
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
		  <th align="center" colspan="1">登录密码</th>
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
        </TR>
		<TR>
          <th align="center" colspan="1">关键词</th>
		  <td class="BGCgray" colspan="2">hanlu</td>
		  <th align="center" colspan="1">登录地址</th>
		  <td class="BGCgray" colspan="2">http://url</td>
        </TR>
		<TR>
          <th align="center" colspan="1">客户端下载地址(IOS)</th>
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
		  <th align="center" colspan="1">二维码下载地址(IOS)</th>
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
        </TR>
		<TR>
          <th align="center" colspan="1">客户端下载地址(Android)</th>
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
		  <th align="center" colspan="1">二维码下载地址(Android)</th>
		  <td class="BGCgray" colspan="2"><input type="text" /></td>
        </TR>
		<TR>
          <th align="center" colspan="1">关键词开始日期</th>
		  <td class="BGCgray" colspan="2">2013-10-15</td>
		  <th align="center" colspan="1">关键词结束日期</th>
		  <td class="BGCgray" colspan="2">2013-10-15</td>
        </TR>
		<TR>
          <th align="center" colspan="1">关键词有效期</th>
		  <td class="BGCgray" colspan="5">20年</td>
        </TR>
		<TR>
        ...
        <TR>
          ...
          <TD class="BGCgray" colspan="5">嘉顿实业</TD>
        </TR>
        <TR>
		...
		<TR>
          ...
          <TD class="BGCgray" colspan="5">http://a</TD>
        </TR>
		...
		<TR>
          ...
          <TD class="BGCgray" colspan="2">法人1</TD>
		  <th width="20%" align="center">注册日期</th>
          <TD class="BGCgray" colspan="2">2012-01-01</TD>
        </TR>
		<TR>
          <th width="20%" align="center">证件类型</th>
          <TD class="BGCgray" colspan="2">营业执照</TD>
		  <th width="20%" align="center">证件号码</th>
          <TD class="BGCgray" colspan="2">123123123123321</TD>
        </TR>
		<TR>
          <th width="20%" align="center">国家</th>
          <TD class="BGCgray" colspan="2">中国</TD>
		  <th width="20%" align="center">省/地区</th>
          <TD class="BGCgray" colspan="2">北京市</TD>
        </TR>
		<TR>
          <th width="20%" align="center">公司传真</th>
          <TD class="BGCgray" colspan="2">999</TD>
		  <th width="20%" align="center">城市</th>
          <TD class="BGCgray" colspan="2">北京</TD>
        </TR>
		<TR>
          <th width="20%" align="center">公司电话</th>
          <TD class="BGCgray" colspan="2">123123</TD>
		  <th width="20%" align="center">区</th>
          <TD class="BGCgray" colspan="2">密云</TD>
        </TR>
		<TR>
          <th width="20%" align="center">公司地址</th>
          <TD class="BGCgray" colspan="5">地址1</TD>
        </TR>
		<TR>
          <th width="20%" align="center">备注</th>
          <TD class="BGCgray" colspan="5">
			<textarea cols="25" rows="6" readonly>暂无</textarea>
		  </TD>
        </TR>
		<TR>
      ...
      <div style="width:100%; text-align:center; padding:5px">
        <BUTTON style="HEIGHT:25px" onClick="javascript:if (confirm('保存信息？')) location.href='website-list.jsp';else return;"><img src="images/btn_save.gif" width="16" height="16" align="absmiddle"> 保存</BUTTON>
