...
public class UserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if ("insert".equals(method)) {
			...
			upload(req, resp, userService);
		} else if("update".equals(method)){
			update(req, resp, userService);
	...
	private void upload(HttpServletRequest req,
			HttpServletResponse resp, UserService userService) throws IOException{
		
		String filePath=getServletContext().getRealPath("/upload");
		
		UploadFile.upload(req, filePath);
		
		resp.sendRedirect("pages/info/user-info.jsp");
	...
	private void change(HttpServletRequest req,
			HttpServletResponse resp, UserService userService) throws IOException{
